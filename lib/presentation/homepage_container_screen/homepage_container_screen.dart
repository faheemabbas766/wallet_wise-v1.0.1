...
@override Widget build(BuildContext context) { return SafeArea(child: Scaffold(body: Navigator(key: navigatorKey, initialRoute: AppRoutes.homepagePage,
    onGenerateRoute: (routeSetting) => PageRouteBuilder(pageBuilder: (ctx, ani, ani1) => getCurrentPage(context, routeSetting.name!), transitionDuration: Duration(seconds: 0))),
    ...
    floatingActionButton: Container(
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: Colors.amber.withOpacity(0.7), // Adjust opacity as needed
            spreadRadius: 5,
            blurRadius: 10,
