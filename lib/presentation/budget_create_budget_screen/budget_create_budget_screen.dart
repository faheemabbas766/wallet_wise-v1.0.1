...
import 'provider/budget_create_budget_provider.dart';

class BudgetCreateBudgetScreen extends StatefulWidget {
  const BudgetCreateBudgetScreen({Key? key})
      : super(
          key: key,
        );

  @override
  BudgetCreateBudgetScreenState createState() =>
      BudgetCreateBudgetScreenState();
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => BudgetCreateBudgetProvider(),
      child: BudgetCreateBudgetScreen(),
    );
  }
}

class BudgetCreateBudgetScreenState extends State<BudgetCreateBudgetScreen> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Widget _buildFrame(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Selector<BudgetCreateBudgetProvider, BudgetCreateBudgetModel?>(
            selector: (
              context,
              provider,
            ) =>
                provider.budgetCreateBudgetModelObj,
            builder: (context, budgetCreateBudgetModelObj, child) {
              return CustomDropDown(
                ...
                items: budgetCreateBudgetModelObj?.dropdownItemList ?? [],
                onChanged: (value) {
                  context.read<BudgetCreateBudgetProvider>().onSelected(value);
                },
              );
            },
          ),
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                Selector<BudgetCreateBudgetProvider, bool?>(
                  selector: (
                    context,
                    provider,
                  ) =>
                  ...
                  builder: (context, isSelectedSwitch, child) {
                    return CustomSwitch(
                      ...
                      onChange: (value) {
                        context
                            .read<BudgetCreateBudgetProvider>()
