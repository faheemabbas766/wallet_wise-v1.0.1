...
import 'package:wallet_wise/widgets/app_bar/appbar_subtitle_six.dart';
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text(
                          "lbl_rs_0".tr,
                          style: CustomTextStyles.displayLargeRedA700,
                        ),
                      ),
  ...
  Widget _buildFrame1(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Selector<ExpenseProvider, ExpenseModel?>(
            selector: (
              context,
              provider,
            ) =>
                provider.expenseModelObj,
            builder: (context, expenseModelObj, child) {
              return CustomDropDown(
                ...
                items: expenseModelObj?.dropdownItemList ?? [],
                onChanged: (value) {
                  context.read<ExpenseProvider>().onSelected(value);
                },
              );
            },
          ),
          SizedBox(height: 16.v),
          Selector<ExpenseProvider, TextEditingController?>(
            selector: (
              context,
              provider,
            ) =>
                ...
                Selector<ExpenseProvider, bool?>(
                  ...
                  builder: (context, isSelectedSwitch, child) {
                    return CustomSwitch(
                      ...
                      onChange: (value) {
                        context.read<ExpenseProvider>().changeSwitchBox1(value);
                      },
                    );
                  },
                ),
